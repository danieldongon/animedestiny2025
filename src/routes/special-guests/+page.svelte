<script>
  ...
  import { vtubers } from './vtuber-guests.js';
  ...
  const filledVTuberGuests = [
    ...vtubers,
    ...Array.from({ length: maxGuests - vtubers.length }, () => ({
      name: "Coming Soon...",
      socials: null,
      image: "/images/mystery.png",
      blurb: null,
          ...
          <div>
            ...
            {#if expanded[i]}
              ...
              <div class="text-center">
                ...
                {/if}
                {#if guest.social_type === "twitter"}
                <a
                  class="inline-block mt-3 text-black-500 hover:text-black-600"
                  href={guest.socials}
                  target="_blank"
                  rel="noopener noreferrer"
...
<div class="container mx-auto  px-4 py-4">
    <p>We're also excited to announce our special Vtuber guest lineup for Anime Destiny 2026! Click on each image to learn about them.</p>
  </div>
<!--note to self: pls make a function so the code isn't repeated twice :p-->
<div  class="container mx-auto px-4 py-12"></div>
<div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-6 items-start">
  {#each filledVTuberGuests as guest, i (i)}
    <div class="bg-gray-50 rounded-lg shadow flex flex-col">
      <!-- Image area: clickable for real guests, static for coming soon -->
          <div>
            <!-- Clickable image -->
